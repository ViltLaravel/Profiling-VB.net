Public Class frmemployee
    ...
    Private Sub frmemployee_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cleartext(GroupBox9)
        cleartext(GroupBox10)
        fillcbo("SELECT `SUBJECT_HANDLED` FROM `tbldepartment` ", cbodeaprtment)
        If empid = "" Then
            loadautonumber("employee", txtcode)
        Else
            txtcode.Text = empid
    ...
    Private Sub cbodeaprtment_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbodeaprtment.SelectedIndexChanged
